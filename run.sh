...
echo ""
echo "Python:"
echo -n "bubbleSort     " & time python ./bubbleSort/bubbleSortPython/test.py         -OO >/dev/null
echo -n "fibonacciCycle " & time python ./fibonacciCycle/fibonacciCyclePython/test.py -OO >/dev/null
echo -n "fibonacciRec   " & time python ./fibonacciRec/fibonacciRecPython/test.py     -OO >/dev/null
echo -n "ip             " & time python ./ip/ipPython/test.py                         -OO >/dev/null
echo -n "table          " & time python ./table/tablePython/test.py                   -OO >/dev/null
